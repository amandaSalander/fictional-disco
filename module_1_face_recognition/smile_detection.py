...
smile_detection=cv2.CascadeClassifier('module_1_face_recognition/haarcascade_smile.xml')
...
def detect(gray, frame):
    ...
    for (x,y,w,h) in faces:
        ...
        # detect s,ile on the detected face of course !!!!
        smiles=smile_detection.detectMultiScale(roi_gray,1.7,22)
